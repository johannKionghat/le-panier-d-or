 ...
 */
final class Version20240625151841 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE listings (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, price NUMERIC(10, 2) NOT NULL, category VARCHAR(255) NOT NULL, photo_url VARCHAR(255) NOT NULL, created_at DATE DEFAULT NULL, INDEX IDX_9A7BD98EA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE favorites ADD CONSTRAINT FK_E46960F5100E894D FOREIGN KEY (listning_id) REFERENCES listings (id)');
        $this->addSql('ALTER TABLE filters ADD CONSTRAINT FK_7877678DA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE listings ADD CONSTRAINT FK_9A7BD98EA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        ...
        $this->addSql('ALTER TABLE messages ADD CONSTRAINT FK_DB021E96D4619D1A FOREIGN KEY (listing_id) REFERENCES listings (id)');
    }
